...
public class ConnectFourBoard {
    ...
    public Status getGameStatus() {
        if (this.status == Status.P1_WINS){
            addp1WinCount();
            addTotalRounds();
        }
        else if (this.status == Status.P2_WINS){
            addp2WinCount();
            addTotalRounds();
        }
        else if (this.status == Status.TIE){
            addTieCount();
            addTotalRounds();
        }
        return this.status;
     ...
     * @return p1WinCount
     */
    public int getP1WinCount(){
        return this.p1WinCount;
    }

    /**
     * gets the player 2 win count
     * @return p2WinCount
     */
    public int getP2WinCount(){
    ...
    /**
     * increments the player 1 win count
     */
    public void addp1WinCount(){
        p1WinCount++;
    }

    /**
     * increments the player 2 win count
     */
    public void addp2WinCount(){
        p2WinCount++;
    }
    ...
    /**
     * increments the total rounds played
     */
